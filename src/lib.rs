...
#[derive(Debug)]
pub struct PrimeYarnProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PrimeYarnProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PrimeYarn processing");
    
    let mut processor = PrimeYarnProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PrimeYarnProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PrimeYarnProcessor::new(false);
